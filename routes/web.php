...
return [
    ...
    ['POST', '/customers/{id}/update', 'CustomerController@update'],
    ['POST', '/customers/{id}/settle-debt', 'CustomerController@settleDebt'],
    ['POST', '/customers/{id}/delete', 'CustomerController@destroy'],
    ['GET', '/clients', 'CustomerController@index'],
    ['POST', '/clients', 'CustomerController@store'],
    ...
    ['POST', '/suppliers/{id}/delete', 'SupplierController@destroy'],
    ['GET', '/fournisseurs', 'SupplierController@index'],
    ['POST', '/fournisseurs', 'SupplierController@store'],
